...
public class PastpapersActivity extends AppCompatActivity {
    ...
    public  class GridViewAdapter extends BaseAdapter{
        ...
        public View getView(int pos, View view, ViewGroup viewGroup){
            ...
            {
                Picasso.get().load(pdf.getPdfIconURL()).placeholder(R.drawable.pdficon).into(pdfIcon);
            }else {
                Toast.makeText(c, "Empty Image URL", Toast.LENGTH_LONG).show();
                Picasso.get().load(R.drawable.pdficon).into(pdfIcon);
            }
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            btnRetrieve.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    new JSONDownloader(PastpapersActivity.this).retrieve(myGridView,myProgressBar);
                }
            });
        }
